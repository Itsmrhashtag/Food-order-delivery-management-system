...
import com.angularspringbootecommerce.backend.repository.OrderItemRepository;
...
public class ProductController {
    ...
    public ResponseEntity<?> removeProductById(@PathVariable Long productId) {
        Optional<Product> productOptional = productService.getProductById(productId);
        ...
        if (!productOptional.isPresent()) {
            ...
            productService.deleteProductAndOrderItems(productId);
