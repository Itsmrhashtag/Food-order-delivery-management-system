...
import com.angularspringbootecommerce.backend.oauth2.CustomOAuth2User;
import com.angularspringbootecommerce.backend.oauth2.CustomOAuth2UserService;
    ...
    public DefaultSecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> {
                    ...
                    auth.requestMatchers("/api/v1/orders/all").permitAll();
