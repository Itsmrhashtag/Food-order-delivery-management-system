...
import com.angularspringbootecommerce.backend.models.Provider;
...
public class AuthenticationService {
    ...
    public User registerAdmin(String email, String password) {
        ...
        UserRole userRole = userRoleRepository.findByAuthority("ADMIN").get();
        Set<UserRole> authorities = new HashSet<>();
    ...
    public User deliveryRegister(String email, String password) {
        String encodedPassword = passwordEncoder.encode(password);

        UserRole userRole = userRoleRepository.findByAuthority("DELHIVERY").get();
        Set<UserRole> authorities = new HashSet<>();
